...
export function SocialLoginButtons({
  ...
  const hasAny = googleEnabled || facebookEnabled || appleEnabled;
    ...
    <div className="space-y-2.5">
      ...
      {appleEnabled && (
        <a
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-900 bg-zinc-900 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-zinc-800"
        >
          <AppleIcon />
